...
import org.apache.wicket.fetch.OnChangeFetchAjaxBehavior;
...
public class HomePage extends WebPage {
    ...
    public HomePage() {
        ...
        field2.add(new OnChangeFetchAjaxBehavior() {
            @Override
            protected void onUpdate(AjaxRequestTarget target) {
                target.appendJavaScript("{\"callback\": \"OnChangeFetchAjaxBehavior.callback\"}");
                System.out.println("OnChangeFetchAjaxBehavior onUpdate");
            }
        });
        TextField<String> field3 = new TextField<>("field3", field3Model);
//        field3.add(new MyExperimentalBehaviour());
//        field3.add(new OnChangeAjaxBehavior() {
//            @Override
//            protected void onUpdate(AjaxRequestTarget target) {
//                System.out.println("OnChangeAjaxBehavior onUpdate");
//            }
//        });
        add(field1);
        add(field2);
